...
```{r}
youth <- read_csv("data/YRBS2015.csv", na = "_____",
                  col_types = cols(
                    .default = col_________(),  #set default to skip any columns we don't specify
                    Year = col_double(),
                    `Analysis weight` = col_double(),
                    `Record ID` = col_double(),
                    AgeCat = col_______(),  #make a number to remove "years old"
                    Gender = col_character(),
                    Grade = col_________(),  #make a number to remove 'th grade
                    Race4 = col_character(),
                    ...
                    `Soda drinking` = col________(), #make character
                    `How many glass of milk 7 days` = col_character(),
                    `Breakfast eating` = col__________(), #make character
                    `Physical activity >= 5 days` = col_______(), #make character
...
```{r}
youth %>% 
  _________("data/yrbs_health_only.csv")
```
